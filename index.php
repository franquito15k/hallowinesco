...
<!--Gomez Franco Gabriel
    12/11/2024
    Desarrollo Web con PHP y MySQL Desafio Hallowen
-->
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="index.php?modulo=disfraz">Panel de Administración</a></li>
        </ul>
    </nav>
    <header>
        ...
        ?>
                    <section id="disfraces-list" class="section">
                        ...
                        <div class="disfraz">
                            ...
                            ?>
                                <p><img src="img/<?php echo $r['foto']; ?>" width="100%"></p>
                                <!--<p>FOTO BLOB</p>
                                        <p><img src="modulos/mostrar_foto.php?id=<?php //echo $r['id'];
                                                                                    ?>" width="100%"></p>-->
                            <?php
                            } else {
                                echo "<p>No hay fotos cargadas</p>";
                            }
                            ?>
